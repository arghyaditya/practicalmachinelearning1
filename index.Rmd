...
```
By observing the __Accuracy__ of __0.6972__ and confusion matrix, we find that the model is __not able to classify the qualitative weight lifting activities properly__. 
...
rf_model_confusionm
```
By observing the __Accuracy__ of __ 0.9942__ and confusion matrix, we find that the model is __able to classify the qualitative weight lifting activities better than decision tree model__.
